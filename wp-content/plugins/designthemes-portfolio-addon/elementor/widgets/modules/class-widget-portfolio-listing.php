...
class Elementor_Portfolio_Listing extends DTPortfolioElementorWidgetBase {
	...
	protected function content_tab() {
		...
		# General
			$this->start_controls_section( 'dt_section_general', array(
				...
				# Portfolio ID
					$this->add_control( 'portfolioid', array(
						'type'    => Controls_Manager::TEXT,
						'label'   => __('Portfolio ID', 'dtportfolio'),
						'default' => '',
						'description' => __('Enter portfolio ids separated by commas to display portfolio items.', 'dtportfolio'),
					) );
				...
				# Post Style
					$this->add_control( 'portfolio_post_style', array(
						...
						'options' => array(
							...
							'dtportfolio-fullpage'    => esc_html__('Full Page', 'dtportfolio'), 
							'dtportfolio-parallax'    => esc_html__('Parallax', 'dtportfolio'), 
							...
							'dtportfolio-multiscroll' => esc_html__('Multi Scroll', 'dtportfolio')
						),
				...
				# Enable Arrows
					$this->add_control( 'portfolio-multiscroll-enable-arrows', array(
						'type'    => Controls_Manager::SELECT,
						...
						'condition' => [
							'portfolio_post_style' => 'dtportfolio-multiscroll',
						]							
					) );

				# Fullpage Navigation Direction
					$this->add_control( 'portfolio-fullpage-navigation', array(
						'type'    => Controls_Manager::SELECT,
						'label'   => __('Fullpage Navigation Direction', 'dtportfolio'),
						'default' => '',
						'options' => array(
							'' => esc_html__('None', 'dtportfolio'), 
						...
						'condition' => [
							'portfolio_post_style' => 'dtportfolio-fullpage',
						]							
					) );

				# Fullpage Type
					$this->add_control( 'portfolio-fullpage-type', array(
						'type'    => Controls_Manager::SELECT,
				...
				# Disable Mouse Scrolling
					$this->add_control( 'portfolio-disable-auto-scrolling', array(
						'type'    => Controls_Manager::SELECT,
				...
				# Fullpage Splitted Sections
					$this->add_control( 'portfolio-fullpage-splittedsections', array(
						'type'    => Controls_Manager::SELECT,
				...
				# Parallax Effects
					$this->add_control( 'portfolio-parallax-effects', array(
						'type'    => Controls_Manager::SELECT,
						'label'   => __('Parallax Effects', 'dtportfolio'),
						'default' => '',
						'options' => array(
							'' => esc_html__('Default', 'dtportfolio'), 
							'different-parallax-speed' => esc_html__('Different Parallax Speed', 'dtportfolio'), 
							'random-parallax-effect' => esc_html__('Random Parallax Effect', 'dtportfolio')
						),
						'condition' => [
							'portfolio_post_style' => 'dtportfolio-parallax',
						]							
					) );
		...
		# Carousel
			...
			$this->start_controls_section( 'dt_section_carousel', array(
				...
				# Number of Rows
					$this->add_control( 'portfolio-carousel-numberofrows', array(
						'type'    => Controls_Manager::SELECT,
	...
	protected function render() {
		...
		$tpl_default_settings['portfolio-carousel-content-over-slider'] = isset($settings['content']) ? $settings['content'] : '';
