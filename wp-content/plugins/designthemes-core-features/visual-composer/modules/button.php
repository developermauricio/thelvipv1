		...
		"params" => array(
			...
			array(
				...
				'value' => array(
					...
					esc_html__( 'Filled Outline', 'designthemes-core' ) => 'filled filled-outline',
			...
			// Icon Type
      		array(
				...
				'dependency' => array( 'element' => 'style', 'value' => array( '', 'bordered', 'filled', 'filled rounded-corner', 'rounded-corner', 'rounded-border', 'fully-rounded-border', 'filled fully-rounded-corner' ) ),
      			'std' => ''
      		),
