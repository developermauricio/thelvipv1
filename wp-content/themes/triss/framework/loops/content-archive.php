    <div class="dt-sc-posts-list-wrapper"><?php
        ...
        if( have_posts() ):
            ...
            $meta = $obj->triss_post_meta_fields(false);
            ...
            while( have_posts() ):
                ...
                if(get_the_title( $post_ID ) == '') {
                    $post_classes[] = 'post-without-title';
                }?>
        ...
        if( $pagination == 'older_newer' ): ?>
            ...
            <div class="pagination blog-pagination">
                ...
                if(get_previous_posts_link()):
                    ?>
                    <div class="newer-posts"><?php echo get_previous_posts_link( '<i class="fas fa-angle-left"></i>'.esc_html__(' Newer Posts', 'triss') ); ?></div>
                    <?php
                endif;
                if(get_next_posts_link()):
                    ?>
                    <div class="older-posts"><?php echo get_next_posts_link( esc_html__('Older Posts ', 'triss').'<i class="fas fa-angle-right"></i>' ); ?></div>
                    <?php
                endif;
                ?>
            </div><?php
        ...
        elseif( $pagination == 'numbered' ): ?>
            ...
            <div class="pagination blog-pagination"><?php echo triss_pagination(); ?></div><?php
