        ...
        <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
            ...
            if( isset($_REQUEST['action'] ) ):
                if( $_REQUEST['action'] === "success" ):
                    ...
                    echo '<p>'.esc_html__('To continue or make another one, please click this button', 'triss').'</p>';
                ...
                $fetch_end_time = isset($_REQUEST['end-time']) ? $_REQUEST['end-time'] : '';?>
                    ...
                    <div class="column dt-sc-one-half first">
                        <h5><?php esc_html_e('Available Services','triss');?></h5>
                        <select name="services" class="dt-select-service">
                            <option value=""><?php esc_html_e('Select','triss');?></option><?php
                    ...
                    <div class="column dt-sc-one-half">
                        <h5><?php esc_html_e('Staffs','triss');?></h5>
                    ...
                    <div class="dt-sc-title with-right-border-decor"><h3><?php esc_html_e('Time','triss');?></h3></div>
                    <div class="dt-sc-hr-invisible-very-small"> </div>
                    <div class="dt-sc-clear"> </div>

                    <div class="column dt-sc-one-fourth first">
                        <h5><?php esc_html_e('I am available on','triss');?></h5>
                    ...
                    <div class="column dt-sc-three-fourth">
                        ...
                        <div class="column dt-sc-one-half first">
                            <h5><?php esc_html_e('Start :','triss');?></h5><?php
                                $time_format = get_option( 'time_format' ); 
                                $fetch_start_time = isset($_REQUEST['start-time']) ? date($time_format, strtotime($_REQUEST['start-time'])) : date($time_format, strtotime('8:00 am'));
                        ...
                        <div class="column dt-sc-one-half">
                            <h5><?php esc_html_e('End :','triss');?></h5>
                    ...
                    <p class="aligncenter"><a href="#" class="dt-sc-button medium bordered show-time"><?php esc_html_e('Show Time','triss');?></a></p>
                    ...
                    <div id="personalinfo" class="personal-info" style="display:none;">
                        <div class="dt-sc-title with-right-border-decor"><h3><?php esc_html_e('Personal Info','triss');?></h3></div>
                        <div class="dt-sc-hr-invisible-very-small"> </div>
                        <div class="dt-sc-clear"> </div>

                        <div class="column dt-sc-one-half first">
                            <p><input type="text" name="name" value="<?php if(isset($_REQUEST['cli-name'])) echo esc_attr($_REQUEST['cli-name']); ?>" placeholder="<?php esc_attr_e('Name:','triss');?>"></p>
                        </div>
                        <div class="column dt-sc-one-half">
                            <p><input type="email" name="email" value="<?php if(isset($_REQUEST['cli-email'])) echo esc_attr($_REQUEST['cli-email']); ?>" required placeholder="<?php esc_attr_e('Email:','triss');?>"></p>
                        </div>
                        <div class="column dt-sc-one-half first">
                            <p><input type="text" name="phone" value="<?php if(isset($_REQUEST['cli-phone'])) echo esc_attr($_REQUEST['cli-phone']); ?>" required placeholder="<?php esc_attr_e('Phone:','triss');?>"></p>
                        </div>
                        <div class="column dt-sc-one-half">
                            <div class="choose-payment" style="display:none;"><?php
                                ...
                                <select name="payment_type">
                                    <option value=""><?php esc_html_e('Choose Payment','triss');?></option>
                                    <?php if( !empty($payatarrival) ): ?>
                                        <option value="local"><?php esc_html_e('Pay At Arrival','triss');?></option>
                                    <?php endif;?>
                                    <?php if( !empty($paypal) ): ?>
                                        <option value="paypal"><?php esc_html_e('Pay with Paypal','triss');?></option>
                                    <?php endif;?>
                                </select>
                            </div>
                        </div>
                        <textarea name="note" placeholder="<?php esc_attr_e('Note:','triss');?>"><?php if(isset($_REQUEST['cli-msg'])) echo esc_attr($_REQUEST['cli-msg']); ?></textarea><?php
                            $temp = $ctemp = rand(3212, 8787);
                            $temp = str_split($temp, 1);?>

                        <div class="column dt-sc-one-half first">
                            <p><input type="text" name="captcha" required  placeholder="<?php esc_attr_e('Captcha','triss');?>"></p>
                    ...
                    <p class="aligncenter"><a href="#" class="dt-sc-button medium bordered schedule-it" style="display:none;"><?php esc_html_e('Schedule It', 'triss'); ?></a></p>
                <?php
            endif;?>
